...
const FREIGHT_DATA = {
  ...
  channels: [
    ...
    },
    {
      ...
      prices: {
        shenzhen: {
          west:    { 21: 16.0, 51: 14.0, 100: 13.0 },
          central: { 21: 17.5, 51: 15.5, 100: 14.5 },
          east:    { 21: 18.5, 51: 16.5, 100: 15.5 }
        },
        yiwu: {
          west:    { 21: 15.6, 51: 13.6, 100: 12.6 },
          central: { 21: 17.1, 51: 15.1, 100: 14.1 },
          east:    { 21: 18.1, 51: 16.1, 100: 15.1 }
        }
      }
    },
    {
      ...
      prices: {
        shenzhen: {
          ...
          central: { 21: 15.4, 51: 13.4, 100: 12.4 },
          east:    { 21: 16.4, 51: 14.4, 100: 13.4 }
        }
      }
    },
    {
      ...
      prices: {
        shenzhen: {
          west:    { 21: 14.6, 51: 12.6, 100: 11.6 },
          central: { 21: 16.3, 51: 14.3, 100: 13.3 },
          east:    { 21: 17.3, 51: 15.3, 100: 14.3 }
        },
        yiwu: {
          west:    { 21: 14.3, 51: 12.3, 100: 11.3 },
          central: { 21: 16.0, 51: 14.0, 100: 13.0 },
          east:    { 21: 17.0, 51: 15.0, 100: 14.0 }
        }
      }
    },
    {
      ...
      prices: {
        shenzhen: {
          west:    { 21: 14.0, 51: 12.0, 100: 11.0 },
          central: { 21: 15.5, 51: 13.5, 100: 12.5 },
          east:    { 21: 16.5, 51: 14.5, 100: 13.5 }
        },
        yiwu: {
          west:    { 21: 14.0, 51: 12.0, 100: 11.0 },
          central: { 21: 15.5, 51: 13.5, 100: 12.5 },
